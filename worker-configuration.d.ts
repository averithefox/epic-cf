/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dfff5099bf18d3823a4c1e974dcea712)
// Runtime types generated with workerd@1.20260915.1 2026-09-07 
interface __BaseEnv_Env {
	EpicKV: KVNamespace;
	DISCORD_TOKEN: string;
	DISCORD_PUBLIC_KEY: string;
	DISCORD_APPLICATION_ID: string;
	EpicDb: DurableObjectNamespace<import("./src/index").EpicDb>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EpicDb";
	}
